...
apk add --no-cache ncurses tzdata pv jq rsync cgpt unzip fastfetch lsblk wpa_supplicant curl coreutils bash openrc dbus ca-certificates sudo iw sfdisk wget tar xz losetup zstd >/dev/null
